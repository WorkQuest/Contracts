task("check_bridge_tokens", "Check token settings in bridge")
    .setAction(async function (args, hre, runSuper) {
        ...
        for (let i = 0; i < token_symbols.length; i++) {
            ...
            console.log(token_info.token, token_symbols[i], token_info.enabled, token_info.native, token_info.lockable);
        }
    });